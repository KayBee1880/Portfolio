...
export const experience: Experience[] = [
    // 2026
    {
        id: "allstate-swe-intern",
        company: "Allstate Insurance",
        role: "Software Engineering Intern (Product Focus)",
        dates: "May 2026 – Aug 2026",
        location: "Northbrook, Illinois",
        type: "Internship",
        tags: ["Java", "Spring Boot", "Full-Stack", "JUnit", "Agile", "SQL"],
        bullets: [
            "Engineered full-stack web applications using Java and Spring Boot, increasing feature deployment efficiency by 15% across 3 core pipelines.",
            "Diagnosed backend bottlenecks using root cause analysis, writing automated Java/JUnit tests that cut manual debugging time by 25%.",
            "Participated in Agile ceremonies to architect reliable backend components, optimizing SQL database query speeds by 30%.",
        ],
        featured: true,
    },
    {
    ...
    // 2025
    {
        ...
        bullets: [
            ...
            "Built lasting relationships with senior engineers and industry professionals across top tech companies to accelerate career growth and expand technical perspective.",
        ],
    },
    {
        id: "ai4all-ignite",
        ...
        bullets: [
            ...
            "Presented AI project findings and ethical analysis to program mentors, demonstrating ability to communicate technical impact and responsible design decisions to cross-functional stakeholders.",
        ],
    },
    {
    ...
    },
    {
        ...
        bullets: [
            ...
            "Applied structured storytelling frameworks to craft a compelling personal brand narrative, effectively communicating technical impact and career trajectory to industry professionals.",
            "Engaged directly with Microsoft Security engineers to deepen understanding of enterprise-scale threat defense, identity management, and zero-trust architecture principles.",
        ],
    },
    {
        ...
        bullets: [
            ...
            "Collaborated with senior engineers in code reviews and sprint planning to ship production-ready backend features with zero critical regressions across deployment cycles.",
        ],
    },
    {
        id: "pwc-extern",
        ...
        bullets: [
            ...
            "Synthesized qualitative and quantitative research into executive-ready deliverables, applying data-driven frameworks to inform strategic recommendations across digital transformation initiatives.",
        ],
    },
    {
        id: "snap-swe-extern",
        ...
        bullets: [
            ...
            "Architected scalable front-end data pipelines to handle high-frequency event streams, ensuring sub-100ms render times for dashboards serving live AR session telemetry.",
        ],
        featured: true,
    },
    {
        ...
        bullets: [
            ...
            "Completed CYB 101 and 102 with distinction, building production-ready detection rules and incident response playbooks applied to multi-vector attack scenarios in controlled lab environments.",
        ],
    },
    {
        id: "amd-developer-program",
        company: "AMD",
        role: "Developer Program Participant",
        dates: "2025",
        location: "Remote, USA",
        type: "Program",
        tags: ["Hardware Architecture", "Compute Optimization", "CUDA", "GPU", "Systems Programming"],
        bullets: [
            "Selected for AMD’s Developer Program, completing technical workshops on hardware architecture, GPU compute, and performance optimization at the silicon level.",
            "Applied low-level systems knowledge to explore compute-intensive workloads, gaining hands-on exposure to AMD’s toolchain and parallel processing frameworks.",
            "Strengthened understanding of memory hierarchies, instruction pipelines, and hardware-software co-design principles relevant to high-performance computing.",
        ],
    },
    {
        id: "paypal-career-academy",
        company: "PayPal",
        role: "Career Academy Participant (Fintech Engineering)",
        dates: "2025",
        location: "Remote, USA",
        type: "Program",
        tags: ["Fintech", "Backend Systems", "Scalability", "Payments", "Career Development"],
        bullets: [
            "Selected for PayPal’s Career Academy, a competitive fintech engineering prep program centered on scalable backend systems and payments infrastructure.",
            "Developed technical fluency in distributed systems design, API architecture, and high-availability patterns modeled on PayPal’s real-world payment processing pipelines.",
            "Engaged with PayPal engineers to build industry readiness across fraud detection, financial data modeling, and fault-tolerant system design at global scale.",
        ],
    },
    ...
    // 2024
    {
        ...
        bullets: [
            ...
            "Collaborated with Wells Fargo engineers on financial data architecture, gaining exposure to enterprise-grade system design patterns and compliance-driven development practices at scale.",
        ],
        featured: true,
    },
    {
    ...
    },
    {
        ...
        bullets: [
            ...
            "Diagnosed and resolved 50+ hardware and software incidents per semester, maintaining a sub-24-hour average resolution time and ensuring uninterrupted access for students and faculty.",
        ],
    },
    {
        ...
        bullets: [
            ...
            "Designed and deployed RESTful APIs integrated with live market data feeds, enabling sub-second data retrieval and supporting real-time financial decision-making workflows.",
        ],
        featured: true,
    },
    {
